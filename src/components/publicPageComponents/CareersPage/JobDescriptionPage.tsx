...
export default function JobDescriptionPage({ jobPosting }: JobDescriptionPageProps) {
  ...
  return (
    <div className="min-h-screen dark:bg-gray-900 transition-colors duration-300">
      ...
      <Head>
        <title>{jobPosting.title} - Job Application</title>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          >
            <div className="bg-white dark:bg-gray-800 rounded-lg space-y-1">
              ...
              <div className="border-gray-200 dark:border-gray-700 pt-4">
                ...
                <p>Job Category: {jobPosting.category}</p>
                <p>Job Type: {jobPosting.jobType}</p>
              </div>
            </div>
          </motion.div>
          ...
          >
            <div className="sticky top-8">
              <JobApplication jobTitle={jobPosting.title} />
            </div>
          </motion.div>
        </div>
      </main>
