...
export default function SignInForm() {
  ...
  const handleSignIn = async (e: FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      dispatch(
        setEmail(authenticatedUser.user.email || "priya.sharma@example.com")
      );
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-teal-50 px-4">
      ...
      <motion.div
        ...
        className="w-full max-w-[900px] overflow-hidden z-50 rounded-3xl shadow-lg bg-white flex flex-col md:flex-row"
      >
        <div className="hidden md:flex md:w-[380px] bg-teal-700 text-white  flex-col justify-center items-center">
          <motion.div
