          ...
          >
            <div className="bg-white rounded-2xl p-6 shadow-sm border">
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="text-gray-500">{summaryStats.revenue.period}</span>
              </div>
            </div>

            <div className="bg-white rounded-2xl p-6 shadow-sm border">
              <div className="flex items-center justify-between mb-2">
                <span className="text-gray-500 text-sm">Active Doctors Today</span>
                <span className="text-green-600 text-sm font-medium flex items-center gap-1">
                  <TrendingUp className="w-3 h-3" />
              ...
              <div className="flex items-center gap-2">
                <span className="text-2xl font-bold text-gray-900">
                  {summaryStats.activeDoctors.available}/{summaryStats.activeDoctors.total}
                </span>
            ...
            <div className="bg-white rounded-2xl p-6 shadow-sm border">
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="text-gray-500">{summaryStats.totalAppointments.period}</span>
              </div>
            </div>
          </motion.div>
        ...
        >
          <div className="bg-white rounded-2xl shadow-sm border p-6">
            <div className="flex items-center justify-between mb-4">
              <h3 className="font-semibold text-gray-900">{calendarData.currentMonth}</h3>
              <div className="flex items-center gap-2">
            ...
            <div className="bg-teal-50 rounded-xl p-4">
              <div className="text-center">
                ...
                <p className="text-sm font-medium text-gray-700 mb-2">{calendarData.location}</p>
                <div className="text-2xl font-bold text-teal-600">
                  {calendarData.currentTime}
                  <span className="text-sm ml-1">{calendarData.currentPeriod}</span>
                </div>
              </div>
            </div>
          </div>
