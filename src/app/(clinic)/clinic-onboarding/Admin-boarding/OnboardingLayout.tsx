    ...
    <div className=" bg-teal-50 relative overflow-hidden">
      ...
      <div className="flex items-center z-50 justify-center min-h-screen p-4">
        <motion.div
          ...
          className="bg-white rounded-2xl  mt-15 h-[520px] shadow-2xl z-50 overflow-hidden max-w-4xl w-full"
        >
          <div className="flex h-full">
            {/* Left side - Branding */}
            <div className="w-[380px] bg-[#086861] text-white h-full  relative">
              <div className="  ">
                {/* Medical icon */}
                <div className="">
                  <Image
            ...
            <div className="w-2/3 overflow-y-auto max-h-screen p-8 flex flex-col">
              {/* Header */}
