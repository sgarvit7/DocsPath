...
// import { updateClinicInfo } from '@/store/adminSlice';
...
const ProfessionalDetailsPage: React.FC = () => {
     const router = useRouter();
      ...
      const clinicInfo = useSelector((state: RootState) => state.selfOnboarding.clinicInfo);
      ...
      const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
          ...
          // Navigate to next step
           dispatch(nextStep());
          router.push('/clinic-onboarding/self-onboarding/professional-info');
        } catch (error) {
...
//   const router = useRouter();
  ...
  //   field: keyof typeof professionalDetails,
  //   value: string
  // ) => {
  //   dispatch(updateClinicInfo({ [field]: value }));
  // };
